import pytest
from .inactive_tab_rec import InactiveTabRecording
...
def test_create_inactive_tab_rec(saved_tab, test_tab_db):
    ...
    saved_rec = InactiveTabRecording.query.get(inactive_tab_rec.id)
...
def test_get_all_inactive_rec(saved_inactive_tab_recs):
    inactive_tab_recs = InactiveTabRecording.query.all()
